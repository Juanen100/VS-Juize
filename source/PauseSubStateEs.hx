...
class PauseSubStateEs extends MusicBeatSubstate
{
	var grpMenuShit:FlxTypedGroup<Alphabet>;

	var menuItemsnew:Array<String> = ['Resumir', 'Reiniciar cancion', 'Cambiar dificultad', 'Volver al menu'];
	var menuItems:Array<String> = ['Resumir', 'Reiniciar cancion', 'Cambiar dificultad', 'Volver al menu'];
	var difficultyChoices = ['FACIL', 'NORMAL', 'DIFICIL', 'VOLVER'];
		...
		}else if (downP)
		{
			...
			else if (leftP)
			{
				...
				if(!offsetChanged)
				{
					...
					menuItems = ['Reiniciar canción', 'Volver al menu'];
