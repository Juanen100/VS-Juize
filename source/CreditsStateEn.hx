...
class CreditsStateEn extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Nombre - Icono - Descripcion - Link - Color del fondo
			...
			['NEXXOS',		'nothing',		'Fixing sprites stuff and he drew the background people', 'https://github.com/Juanen100/VS-Juize',	0xFF328b4f],
			[''],
			["Kade Engine Team"],
			['KADE DEV',			'nothing',	'Main Programmer of Kade Engine', 'https://www.youtube.com/channel/UCoYksltIxNuSHz_ERzoRP6g',	0xFFffd700],
			['THE CONTRIBUTORS',			'nothing',	'They Contributed to Kade Engine', 'https://github.com/KadeDev/Kade-Engine/graphs/contributors',	0xFF4166f5],
			[''],
			["Specials Thanks"],
