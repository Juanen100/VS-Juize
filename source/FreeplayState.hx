...
class FreeplayState extends MusicBeatState
{
	...
	var testSong:Alphabet;
	var cursorEpic:FlxSprite;
	...
	{
		/*
		Basically all this green shit are test that didn't work (And somethings that Kade Dev changed)
		cursorEpic = new FlxSprite(0, 0).loadGraphic(Paths.image('wii_cursor'));
		cursorEpic.updateHitbox();
		cursorOWidth = cursorEpic.width;
		...
		*/
		...
		isDebug = true;
			...
			/*
			Shit test stuff
			addWeek(['Rolling', 'Remix'], 1, ['juize']); This shit was a test
			addWeek(['Ignite', 'Bruh'], 2, ['juize-angry']);
			*/
